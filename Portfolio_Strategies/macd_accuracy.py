...
shutil.rmtree(
    "/Users/shashank/Documents/Code/Python/Outputs/macd_accuracy/SMA_Analysis/Stocks/"
)
os.mkdir(
    "/Users/shashank/Documents/Code/Python/Outputs/macd_accuracy/SMA_Analysis/Stocks/"
)
...
list_files = glob.glob(
    "/Users/shashank/Documents/Code/Python/Outputs/macd_accuracy/SMA_Analysis/Stocks/*.csv"
)
...
for stock in list_files:
    ...
    while Day < len(macd) - 5:
        ...
        Avg_Closing_Next_Days = (
            prices[Day + 1] + prices[Day + 2] + prices[Day + 3]
        ) / 3
        Days_Observed += 1
...
Compare_Stocks.to_csv(
    "/Users/shashank/Documents/Code/Python/Outputs/macd_accuracy/SMA_Analysis/All_Stocks.csv",
    index=False,
)
Compare_Stocks = pd.read_csv(
    "/Users/shashank/Documents/Code/Python/Outputs/macd_accuracy/SMA_Analysis/All_Stocks.csv"
)
...
df.to_csv(
    "/Users/shashank/Documents/Code/Python/Outputs/macd_accuracy/SMA_Analysis/5_Day_Avg_26_12_MACD.csv",
    index=False,
)
